...
from al_furqan.core.cot import ReasoningStep, COTMonitorResult
...
class TestCOTPrompts:
    ...
    def test_mirror_prompt_contains_cot_instructions(self):
        ...
        prompt = build_cot_mirror_prompt("Is democracy good?", {"primary_system": "political"})
    ...
    def test_monitor_prompt_contains_audit_criteria(self):
        ...
        mirror_result = {
            "gate_1_source_integrity": {
                "reasoning_steps": [{"step_number": 1, "thought": "t", "observation": "o"}],
                "score": 80,
                "result": "Survive",
            }
        }
    ...
    def test_correction_prompt_is_step_aware(self):
        ...
        assert "step numbers" in prompt.lower() or "step_number" in prompt.lower() or "step number" in prompt.lower()  # pylint: disable=line-too-long
...
class TestCOTReasoningEngine:
    ...
    MOCK_COT_MIRROR = {
        "gate_1_source_integrity": {
            "reasoning_steps": [
                {"step_number": 1, "thought": "Checking source", "observation": "No primary source", "axiom_reference": "Source-Integrity"},  # pylint: disable=line-too-long
                {"step_number": 2, "thought": "Evaluating", "observation": "Claim unverified", "conclusion": "Fail"},  # pylint: disable=line-too-long
            ],
            "score": 30,
            "result": "Fail",
        },
        "gate_2_structural_consistency": {
            "reasoning_steps": [
                {"step_number": 1, "thought": "Mapping causality", "observation": "Logical chain holds"},  # pylint: disable=line-too-long
                {"step_number": 2, "thought": "Checking", "observation": "Consistent", "conclusion": "Survive"},  # pylint: disable=line-too-long
            ],
            "score": 75,
            "result": "Survive",
        },
        "gate_3_mediation_zeroing": {
            "reasoning_steps": [
                {"step_number": 1, "thought": "Human bias check", "observation": "Some bias", "conclusion": "Fail"},  # pylint: disable=line-too-long
            ],
            "score": 40,
            "result": "Fail",
        },
        "gate_4_origin_aware": {
            "reasoning_steps": [
                {"step_number": 1, "thought": "Origin check", "observation": "No transcendent ref", "conclusion": "Fail"},  # pylint: disable=line-too-long
            ],
            "score": 20,
            "result": "Fail",
        },
    ...
    def test_evaluate_with_cot_full_pipeline(self):
        ...
        verdict, cot_monitor = engine.evaluate_with_cot("Is interest-based banking ethical?")
