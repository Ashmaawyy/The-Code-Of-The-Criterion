...
class SemanticToken:
    ...
    referent: str = ""             # what a pronoun/demonstrative points to (verse_key:position or "")
...
class LogicToken:
    ...
    connects_to: list[int] = field(default_factory=list)  # positions of words this logically links to
    negation_scope: list[int] = field(default_factory=list)  # positions negated by this word
